...
float laser_controller(float wind_angle){
        ...
        return catapult_controller_constrain(laser_controller_angle, -10, -1);
}
...
void catapult_controller(catapult_controller_handle_t *handle, button_event_t *event)
{
        ...
        case STATE_CATAPULT_ACCUMULATE:
                ...
                // handle->wind_angle = catapult_controller_constrain(handle->wind_angle - 0.5, 0, 180);
                break;
        ...
        case STATE_CATAPULT_DECAY:
                handle->wind_angle = catapult_controller_constrain(handle->wind_angle + 0.5, 0, 145);
        ...
        handle->laser_angle = catapult_controller_constrain((handle->wind_angle - CATAPULT_WIND_DEFAULT_ANGLE) / 10, -8, -2);
