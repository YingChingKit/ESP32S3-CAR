...
#define GPIO_BUTTON_SHOOT (JOYSTICK_SHIELD_BUTTON_C)
#define GPIO_BUTTON_TILT_LEFT (JOYSTICK_SHIELD_BUTTON_D)
#define GPIO_BUTTON_TILT_RIGHT (JOYSTICK_SHIELD_BUTTON_B)
#define GPIO_BUTTON_SET_SERVO (JOYSTICK_SHIELD_BUTTON_E)
#define GPIO_BUTTON_RESET_SERVO (JOYSTICK_SHIELD_BUTTON_F)
=======
// Car controls
